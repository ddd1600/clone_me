...
This rails app has twitter bootstrap on it. One version back from the latest as of this date. Most of its other methods are either in `config/initializers/ddd_m_patches.rb` or `lib/*/*`.
